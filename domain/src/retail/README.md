...
- Contract coverage exists in storage tests such as `retired clean-slate contract: `storage/tests/core_service_contract_storage.rs`` and `retired clean-slate contract: `storage/tests/operations_storage_contracts.rs``, and Gingr endpoint/mapping coverage lives in `retired clean-slate contract: `integrations/gingr/tests/endpoint_contracts.rs`` and `retired clean-slate contract: `integrations/gingr/tests/expanded_endpoint_contracts.rs``.
