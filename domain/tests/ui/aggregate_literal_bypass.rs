...
fn main() {
    ...
    let _message_bypass = entities::Message {
        id: entities::MessageId(Uuid::from_u128(23)),
        subject: entities::MessageSubject::Reservation(entities::reservation::Id(
            Uuid::from_u128(24),
        )),
    ...
    let _workflow_event_bypass = workflow::Event {
        event_id: workflow::EventId(Uuid::from_u128(35)),
        ...
        location_id: entities::LocationId(Uuid::from_u128(36)),
        subject: workflow::Subject::Customer(entities::CustomerId(Uuid::from_u128(37))),
    ...
    let _document_bypass = entities::Document {
        id: entities::DocumentId(Uuid::from_u128(50)),
        location_id: entities::LocationId(Uuid::from_u128(51)),
        subject: entities::DocumentSubject::Pet(entities::PetId(Uuid::from_u128(52))),
    ...
    let _vaccine_bypass = entities::VaccineRecord {
        id: entities::VaccineRecordId(Uuid::from_u128(53)),
        pet_id: entities::PetId(Uuid::from_u128(54)),
        vaccine_name: policy::VaccineName::try_new("Rabies").unwrap(),
        source_document_id: entities::DocumentId(Uuid::from_u128(55)),
    ...
    let _incident_bypass = entities::Incident {
        id: entities::IncidentId(Uuid::from_u128(56)),
        location_id: entities::LocationId(Uuid::from_u128(57)),
        primary_subject: entities::IncidentSubject::Pet(entities::PetId(Uuid::from_u128(58))),
