...
| Labor/value evidence | Before minutes, actual minutes, reported time spent or estimate differences, wrong-source findings, rework reduced, handle time reduced, feedback, reporting group, correlation id. | Reviewed work was measured after the fact. | Guaranteed ROI or safe future automation without review. |
