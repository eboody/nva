# Access needed for the next real pilot step

To convert this from local proof to an NVA pilot, the next access should be narrow and workflow-specific.

Minimum useful access:

1. A non-production or read-only source-data export for one location.
