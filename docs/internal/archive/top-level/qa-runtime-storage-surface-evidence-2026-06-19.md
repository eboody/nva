...
1. Resolved stale/over-claimed Rustdoc in `apps/worker/src/lib.rs`:
   ...
   - Resolution: mention Postgres only as an explicit local/demo or future adapter/storage implementation, not as a deployed worker capability.
