...
- Contract lane: `openapi_title=NVA Pet Resorts Owned Operations API`, `openapi_version=0.1.0`, `openapi_paths=8`, `owned_route=/v1/agent/context/data-quality-hygiene`, `owned_route=/v1/read-models/source-quality-backlog`, and `contract_lane_ok live_side_effects_allowed=false`.
