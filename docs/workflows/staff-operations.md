...
Status: canonical workflow artifact for the current staff-operations workstream. This document synthesizes the completed part artifacts in `docs/workflows/staff-operations-parts/` into one integration contract for product, data-model, task-model, and implementation planning.
