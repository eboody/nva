...
use domain::{money, payment, policy, service};
...
fn booking_triage_rule_contract_composes_boarding_deposit_decision_without_owning_it() {
    ...
    let rule = match readiness {
        service::boarding::deposit::ConfirmationReadiness::Ready => {
        ...
        service::boarding::deposit::ConfirmationReadiness::Blocked { review_gate, .. } => {
