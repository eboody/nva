...
mod request_typestate {
    ...
    ///
    /// The variants record which source-backed prerequisites are present before
    ...
    pub enum RequestState {
        ...
        Intake,
        /// A source-backed pet profile has been attached for policy checks.
    ...
    ///
    /// The state-specific request types emitted by the macro enforce the ordering of evidence
...
impl AiRecommendation {
    ...
    /// Builds or derives recommend staff confirmation data for the booking-readiness workflow's reviewed decision model.
...
impl StaffEvaluationPacket {
    ...
    /// Returns the with ai recommendation value kept on this booking-readiness workflow object for staff review and agent context.
    ...
    /// Returns the with confirmation draft value kept on this booking-readiness workflow object for staff review and agent context.
    ...
    /// Returns the ai recommendation value kept on this booking-readiness workflow object for staff review and agent context.
    ...
    /// Returns the confirmation draft value kept on this booking-readiness workflow object for staff review and agent context.
...
#[derive(Debug, Clone)]
/// Service used by the booking-readiness workflow; it keeps booking work grounded in deterministic policy evidence before any agent draft reaches staff.
