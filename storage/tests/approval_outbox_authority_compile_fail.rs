...
fn approved_internal_handoff_authority_is_opaque_one_shot_and_not_serde() {
    ...
    tests.compile_fail("tests/ui/operations_service_line_convenience_aliases.rs");
    ...
    tests.compile_fail("tests/ui/caller_constructible_approval_evidence_is_absent.rs");
}
